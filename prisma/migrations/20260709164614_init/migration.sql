-- CreateEnum
CREATE TYPE "Role" AS ENUM ('EMPLOYEE', 'STAFF', 'MANAGER');

-- CreateEnum
CREATE TYPE "Category" AS ENUM ('IT', 'HR', 'FACILITIES', 'OTHER');
...
-- CreateIndex
CREATE INDEX "StatusEvent_ticketId_idx" ON "StatusEvent"("ticketId");
